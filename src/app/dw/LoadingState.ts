...
export class LoadingState extends _BaseState {
    ...
    override update(delta: number) {
        ...
        if (!this.assetsLoaded) {
            ...
            game.assets.addSound('MUSIC_TITLE_SCREEN', 'res/sound/01 Dragon Quest 1 - Intro ~ Overture (22khz mono).ogg');
            game.assets.addSound('MUSIC_TANTEGEL', 'res/sound/02 Dragon Quest 1 - Tantegel Castle (22khz mono).ogg');
            game.assets.addSound('MUSIC_TANTEGEL_LOWER', 'res/sound/03 Dragon Quest 1 - Tantegel Castle (Lower) (22khz mono).ogg');
            game.assets.addSound('MUSIC_TOWN', 'res/sound/04 Dragon Quest 1 - Peaceful Village (22khz mono).ogg');
            game.assets.addSound('MUSIC_OVERWORLD', 'res/sound/05 Dragon Quest 1 - Kingdom of Alefgard (22khz mono).ogg');
            game.assets.addSound('MUSIC_BATTLE', 'res/sound/14 Dragon Quest 1 - A Monster Draws Near (16khz mono).ogg', 2.32);
            game.assets.addSound('MUSIC_DUNGEON_FLOOR_1', 'res/sound/06 Dragon Quest 1 - Dark Dungeon - Floor 1 (22khz mono).ogg');
